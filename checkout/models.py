...
class Order(models.Model):
    ...
    def update_total(self):
        ...
        if self.order_total < settings.FREE_DELIVERY_THRESHOLD:
            self.delivery_cost = Decimal(6.95)
        else:
    ...
    def save(self, *args, **kwargs):
        """
            Override the save method and set an order number
...
class OrderLineItem(models.Model):
    ...
    def save(self, *args, **kwargs):
        """
            Override the save method and set/update the
            lineitem total and order total.
        """
